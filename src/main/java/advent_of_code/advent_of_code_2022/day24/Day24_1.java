...
public class Day24_1 {
    ...
    public static void main(String[] args) {
        ...
        var xrange = new IntRange(grid.xmin(), grid.xmax());
        var yrange = new IntRange(grid.ymin(), grid.ymax());
    ...
    public static Grid<List<String>> nextGrid(Grid<List<String>> grid,
                                              IntRange xrange,
                                              IntRange yrange
                                             ) {
    ...
    public static Grid<List<String>> moveArrow(Pos source,
                                               String arrow,
                                               Grid<List<String>> ys,
                                               IntRange xrange,
                                               IntRange yrange
        ...
        Pos target = switch (arrow) {
            case UP -> (source.y() == yrange.min() + 1) ?
                    new Pos(source.x(), yrange.max() - 1) :
                    new Pos(source.x(), source.y() - 1);
            case DOWN -> (source.y() == yrange.max() - 1) ?
