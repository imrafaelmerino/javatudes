...
import java.util.stream.Stream;
 ...
 abstract class Search<State> {
     ...
     * @param getSuccessors     function that takes a state and produces pairs with the new states and the actions to reach them
    ...
    protected SearchPath<State> findFirst(State initial,
        ...
        Collection<State> explored = new HashSet<>();
